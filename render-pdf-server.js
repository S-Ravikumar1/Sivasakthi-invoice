...
app.post("/render",async(req,res)=>{
  ...
  *{box-sizing:border-box}html,body{margin:0;padding:0;background:#fff;font-family:Arial,Helvetica,sans-serif;color:#222}.paper{width:210mm;height:297mm;background:#fff;padding:8mm}.frame{border:2px solid #444;height:281mm;overflow:hidden;position:relative}.top{height:60px;border-bottom:1px solid #444;display:grid;grid-template-columns:1fr 235px}.title{text-align:center;font-size:18px;font-weight:800;padding-top:10px}.meta{border-left:1px solid #444;text-align:right;padding:5px 8px;font-size:16px;font-weight:800;line-height:24px}.seller{height:105px;text-align:center;border-bottom:2px solid #444;padding:11px 8px;font-size:12px;line-height:18px}.seller .name{font-family:Georgia,serif;font-size:30px;font-weight:700}.party{height:95px;border-bottom:1px solid #444;padding:10px 8px;font-size:12px;line-height:18px}.party .name,.party .addr{font-size:16px;line-height:20px}.party .name{font-weight:800}.table{width:100%;border-collapse:collapse;table-layout:fixed}.table th,.table td{border:1.5px solid #777;padding:7px;font-size:10.5px}.table th{font-size:10px;text-align:center;height:36px}.table .desc{width:55%;text-align:center;vertical-align:top}.table th:nth-child(2){width:12%}.table th:nth-child(3){width:8%}.table th:nth-child(4){width:12%}.table th:nth-child(5){width:13%}.r{text-align:right}.empty td{height:260px}.summary{display:grid;grid-template-columns:1fr 318px;border-top:1.5px solid #777}.words{min-height:130px;height:130px;padding:10px;font-size:9.5px;border-right:1.5px solid #777}.words b{display:block;margin-bottom:5px}.totals{font-size:10px}.tr{display:flex;justify-content:space-between;padding:7px 8px;border-bottom:1.5px solid #777;min-height:30px}.grand{font-size:12px;font-weight:800}.decl{display:grid;grid-template-columns:1fr 1fr;height:110px;min-height:110px;border-top:1.5px solid #777;position:absolute;left:0;right:0;bottom:0;background:#fff}.half{padding:12px 8px;font-size:10px;position:relative}.half:first-child{border-right:1.5px solid #777}.auth{position:absolute;left:8px;bottom:15px;font-weight:700}.decl b{display:block;margin-bottom:7px;font-size:10.5px}.decltext{font-size:9.5px;line-height:15px}.pn{font-weight:800;font-size:10.5px;margin-bottom:3px}.ih,.ir{display:grid;grid-template-columns:1fr 1fr;gap:2px;text-align:center}.ih{font-weight:800;font-size:9px;margin:4px 0 2px;text-transform:uppercase}.ir{font-size:9px;line-height:13px;font-weight:400}.pt{font-weight:700;font-size:9px;margin-top:3px}
